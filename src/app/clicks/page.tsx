      ...
      <div className="flex flex-col justify-center  p-4 mt-4 w-full ">
        <label htmlFor="id" className="relative w-full ">
          <input
            ...
            className=" border-2 w-full  border-white/10 focus:outline-none focus:border-white duration-200 p-4 rounded-lg bg-transparent"
          />
          <span className="absolute -top-3 font-medium  tracking-wide left-4 bg-black text-md">
            Enter Your ShortId
          </span>
        </label>
        <button
          onClick={getClicks}
          className=" bg-white md:mt-7 md:m-auto text-black lg:w-1/5 w-1/2 mt-2 text-xl font-medium justify-center  flex rounded-lg gap-4 items-center p-3 text-center"
        >
        ...
        {renderClickDiv ? (
          ...
          <div className="flex flex-col md:items-start md:justify-start gap-3 mt-7">
            ...
            <p className=" text-md font-medium">
              The last 5 digit at the end of url
            </p>
            <h1 className=" text-xl font-semibold">For Example :</h1>
            <h1 className=" text-xl font-semibold">
              Url : trim.theshiva.xyz/xyz12
            </h1>
